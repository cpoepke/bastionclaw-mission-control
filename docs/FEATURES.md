...
## Overview
Mission Control is the central operating dashboard for the BastionClaw multi-agent system. It provides a real-time interface for managing tasks, monitoring agent status, and tracking system activities.
